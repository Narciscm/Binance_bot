"""
Scriptul verifica cea mai buna optiune dintr-o lista de active crypto definita,
...
trail_percent = 0.02  # Trailing stop-loss de 2%
...
def monitor_market(symbol, buy_price, quantity):
    ...
    while True:
        ...
        time.sleep(60)
        print("Verifica daca pretul a crescut sau scazut pentru perechea cumparata")
...
while True:
    ...
    # Iterăm prin perechile de crypto pentru a găsi cea mai bună oportunitate
